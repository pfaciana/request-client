...
trait CurlOptionsTrait
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($curlOptions, $merge), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (!$curlOptions) {
			return FALSE;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($curlOption, $curlValue), false)) !== __AM_CONTINUE__) return $__am_res; 
		$curlOptions = [];
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($curlOption), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($code, $prefix), false)) !== __AM_CONTINUE__) return $__am_res; 
